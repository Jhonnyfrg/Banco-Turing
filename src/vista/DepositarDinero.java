...
public class DepositarDinero extends javax.swing.JFrame {
    ...
    // Variables para almacenar información del usuario y configuración del idioma
    ...
    private void BotonAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonAtrasActionPerformed
        ...
        menu.datos(nombre, nro, apellido, idioma); // Configura los datos del usuario en el menú de transacciones
        menu.idioma(idioma); // Configura el idioma en el menú de transacciones
        menu.cargarDatos(); // Carga los datos del usuario en el menú de transacciones
        menu.mantCuenta(selec); // Mantiene la cuenta seleccionada en el menú de transacciones
    ...
    private void BotonDepositoOtraCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonDepositoOtraCuentaActionPerformed
        ...
        depositotro.datos(nombre, nro, selec, apellido, idioma); // Configura los datos del usuario en la ventana de depósito en otra cuenta
        depositotro.idioma(idioma); // Configura el idioma en la ventana de depósito en otra cuenta
        depositotro.setVisible(true); // Muestra la ventana de depósito en otra cuenta
        this.dispose(); // Cierra la ventana actual
    ...
    private void BotonDepositoCuentaPropiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonDepositoCuentaPropiaActionPerformed
         ...
         propia.datos(nombre, nro, selec, apellido, idioma); // Configura los datos del usuario en la ventana de depósito en cuenta propia
         propia.idioma(idioma); // Configura el idioma en la ventana de depósito en cuenta propia
         propia.setVisible(true); // Muestra la ventana de depósito en cuenta propia
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DepositarDinero().setVisible(true); // Crea y muestra la ventana de DepositarDinero
            }
        });
    }
